resource "azurerm_private_endpoint" "db_private" {
  ...
  private_service_connection {
    name                           = "man-kubernetes-to-db-${var.env_prefix}"
    private_connection_resource_id = "/subscriptions/c47c194f-0987-40d0-b8fe-0a2086a01dc8/resourceGroups/${azurerm_resource_group.rg.name}/providers/Microsoft.DBforMariaDB/servers/${azurerm_mariadb_server.man_mariadb.name}"
